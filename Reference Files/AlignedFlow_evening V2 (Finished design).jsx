...
export default function EveningRoutine() {
  ...
  return (
    <div style={{ position: "relative", height: "100vh", background: "#0f0e0c", overflow: "hidden", fontFamily: "Georgia, serif" }}>
      ...
      <div style={{ position: "absolute", left: 0, right: 0, top: 0, height: 2, background: COLOR, opacity: 0.75, transform: `translateY(${(100 - fillPct) * window.innerHeight / 100}px)`, transition: "background 0.6s", pointerEvents: "none", zIndex: 2 }} />
