...
export default function AlignedFlow() {
  ...
  return (
    <div style={{ position: "relative", minHeight: "100vh", background: "#0f0e0c", fontFamily: "Georgia, serif", overflow: "hidden" }}>
      ...
      <div onClick={onPlayPause} style={{ position: "relative", zIndex: 5, minHeight: "100vh", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", padding: isMobile ? "1.25rem 1.25rem 5rem 40px" : "2rem 2rem 5rem 68px", cursor: "pointer" }}>
